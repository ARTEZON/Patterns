abstract class StudentBase {
    companion object {
        ...
        @JvmStatic
        protected fun isValidPatronym(value: String) = value.isEmpty() || isValidName(value)
        @JvmStatic
        protected fun isValidPhoneNumber(value: String?) = value == null || phoneRegex.matches(value)
        @JvmStatic
